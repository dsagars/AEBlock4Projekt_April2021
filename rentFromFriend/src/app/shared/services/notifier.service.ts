...
export class NotifierService {
  ...
  constructor(private snackBar: MatSnackBar, @Inject(DOCUMENT) private _document: Document) { }

  
  // Dieser Service bieten allen an verschiedene Notifications anzuzeigen
  ...
  showForFiveSeconds(displayMessage: string, displayButtonText: string){
   ...
   showAndRefreshAfterDismissal(displayMessage: string, displayButtonText: string) {
